            ...
            children: [
              ...
              GridView.count(
                ...
                children: [
                  ...
                  // TEMPORÁRIO (2026-09-08): o card da Chuva continua na
                  // grade, mas com o toque inibido (tap = null) enquanto
                  // testam a Pesagem. Para REVERTER: trocar o `null` de volta
                  // por `onNavigate`.
                  _buildMenuCard("Chuva", 'chuva.png', 3, null),
